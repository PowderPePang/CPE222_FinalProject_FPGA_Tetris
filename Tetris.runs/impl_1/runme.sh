...
HD_PWD='C:/Users/paeng/KMUTT/Year2/1-67/CPE222/Vivado/Tetris/Tetris.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log TetrisTopModule.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source TetrisTopModule.tcl -notrace
