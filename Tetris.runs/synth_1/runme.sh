...
HD_PWD='C:/Users/paeng/KMUTT/Year2/1-67/CPE222/Vivado/Tetris/Tetris.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log TetrisTopModule.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source TetrisTopModule.tcl
